...
from legged_obstacle_rl.tasks.manager_based.locomotion import mdp
from legged_obstacle_rl.terrains.config.rough import ROUGH_TERRAINS_CFG
...
class CommandsCfg:
    ...
    base_height = mdp.UniformBodyHeightCommandCfg(
        asset_name="robot",
        resampling_time_range=(8.0, 12.0),
        debug_vis=True,
        ranges=mdp.UniformBodyHeightCommandCfg.Ranges(
            height=(0.25, 0.38),
        ),
    )
...
@configclass
class LocomotionRLEnvCfg(ManagerBasedRLEnvCfg):
